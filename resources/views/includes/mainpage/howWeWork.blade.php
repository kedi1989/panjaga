<h2 class="big-header"><span class="header-gap"></span>Twoje korzyści - Nasza praca</h2>
    <div class="content-container">

    <div class="howwework-service-container">
        <div class="howwework-service-box">
            <div class="left-side-content">
                <div class="howwework-service-video-box">
                    <iframe width="340" height="600" src="https://www.youtube.com/embed/aBwijTKvEaY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="right-side-content">
                <div class="howwework-text-box">
                    <h3 class="medium-header">Pranie tapicerki samochodowej</h3>
        ...
        <div class="howwework-service-box">
            ...
            <div class="left-side-content">
                <div class="howwework-service-video-box">
                    <iframe width="340" height="600" src="https://www.youtube.com/embed/H-Gh5iiylw8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="right-side-content">
                <div class="howwework-text-box">
        ...
        <div class="howwework-service-box">
            <div class="left-side-content">
                <div class="howwework-service-video-box">
                    <iframe width="340" height="600" src="https://www.youtube.com/embed/C1I_hcWRW5g" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="right-side-content">
                <div class="howwework-text-box">
