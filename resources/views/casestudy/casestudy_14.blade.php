        ...
        <div class="content-container">
          ...
          <div class="article-box">
              ...
              <div class="article-image">
                <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/7.jpg') }}" alt="Pranie, czyszczenie narożnika, rogówki - Kościan" />
              </div>
              <p>Lorem ipsum</p>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/1.jpg') }}" alt="-" />
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/2.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/3.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/4.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/5.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/6.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/7.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/14/8.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
