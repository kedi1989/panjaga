...
@section('content')
        ...
        <div class="content-container">
          ...
          <div class="article-box">
              <h1>Mocno zabrudzony narożnik przez dzieci :) Zobacz jak temu zaradziliśmy ! - Śrem</h1>
              <p class="post-published-date">Kwi 6, 2021 | Pranie Tapicerki Narożnika - Śrem</p>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/1/3.jpg') }}" alt="oparcie brudnego narożnika, przyklejona guma do żucia" />
                    <div class="article-image-description-box">
                      <p>Oparcia też trochę dostały, dzieci w dodatku przykleiły gumę :)</p>
                    </div>
                  </div>
              </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/1/4.jpg') }}" alt="brudne oparcie narożnika" />
                    <div class="article-image-description-box">
                      <p>I inny widok. Zdjęcia robione z fleszem więc plamy są bardziej uwidocznione.</p>
                    </div>
                  </div>
              </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/1/5.jpg') }}" alt="zdjęcie brudnego narożnika" />
                    <div class="article-image-description-box">
                      <p>Można rzecz, że tapicerka meblowa zmieniła kolor :) Spokojnie to tylko jej kolor fabryczny</p>
                    </div>
                  </div>
              </div>
              ...
              <h2><strong>Czyszczenie mebli - Słów kilka - Śrem</strong></h2>

              <p>Pranie mebli to nie jest jakaś inwazja :) tylko 1,5 - 3 godzinna praca w zależności od nakładu pracy, wielkości itd. Nie należy bać się, że meble będą mokre kilka dni albo, że coś spleśnieje. Nic z tych rzeczy.</p>

              <p>Po wyciągnięciu wody z brudem z tapicerki mebli, pozostaje tylko wilgoć resztkowa. Odbywa się to pod dużym ciśnieniem odkurzacza piroącego więc mamy pewność, że nie wiele wody zostanie w naszym meblu. Tapicerka zazwyczaj schnie w ciągu 10 godzin a nawet i szybciej.</p>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/1/8.jpg') }}" alt="czysty narożnik wyprany karcherem" />
                    <div class="article-image-description-box">
                      <p>Mebel odzyskany ! I o to właśnie nam chodzi. Klient zadowolony.</p>
                    </div>
                  </div>
              </div>
