        ...
        <div class="content-container">
          ...
          <div class="article-box">
              ...
              <div class="article-image">
                <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/1.jpg') }}" alt="Pranie, czyszczenie narożnika, rogówki - Kościan" />
              </div>
              <p>Lorem ipsum</p>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/2.jpg') }}" alt="-" />
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/3.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/4.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/5.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/6.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/7.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/8.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
              ...
              <div class="inner-article-image-container">
                  <div class="inner-article-image-box">
                    <img class="box-shadow" src="{{ URL::asset('images/casestudy/13/9.jpg') }}" alt="-" />
                    <div class="article-image-description-box">
                      <p>Lorem ipsum</p>
                    </div>
                  </div>
